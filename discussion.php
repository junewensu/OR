...
<body>
  <div class="header head-top " id="home">
    ...
    <ul>
		...
		<li><a href="discussion.php" class="active">讨论区</a></li>
		 <label>/</label>
  ...
  <div id="content" style="width:80%;height:700px;margin:auto;overflow:auto; " class="fix-margin-top">
	  <div class="discussion">
		  <h1 class="discussion_h1" style=" margin-bottom: 17px;font-family: 微软雅黑;">写下您的建议 Please write down some suggests...</h1>
		  <div class="line" style="border-bottom: 6px double #888888;margin-bottom: 30px;display: none;width:50%;"></div>
		  
		 <button class="btn btn-primary pull-right comment_btn hide"><a href="http://june180.duoshuo.com/admin/" target="_blank" style="color:#fff;text-decoration:none;">管理评论</a></button>
         ...
         ?>
		 <!-- 多说评论框 start -->
	<div class="ds-thread" data-thread-key="1的ID" data-title="" data-url=""></div>
<!-- 多说评论框 end -->
<!-- 多说公共JS代码 start (一个网页只需插入一次) -->
<script type="text/javascript">
var duoshuoQuery = {short_name:"june180"};
	(function() {
...
<!-- 多说公共JS代码 end -->
		  <div class="line2" style="border-bottom: 6px double #888888;margin-top: 30px;width:25%;float: right;display: none;"></div>
